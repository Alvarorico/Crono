...
architecture Behavioral of Contador is
    ...
    process (clk_1hz, Start_i, Reset_i,Habilitar_A)
    ...
    begin
       ...
       display3 <= std_logic_vector(to_unsigned(unit_min,display3'length));
       display4 <= std_logic_vector(to_unsigned(dec_min,display4'length));
    end process;
